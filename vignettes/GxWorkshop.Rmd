...
```{r hillSlopeFig, fig.cap="Diagram of a logLogistic Hill Slope"}
knitr::include_graphics("./hillSlope.png")
```
...
```{r hillSlopeSumFig, fig.cap="Some commonly used summary metrics for a dose-response curve"}
...
radSensSig <- radSensitivitySig(Cleveland, mDataType='rna', nthread=16, features=fNames(Cleveland, 'rna')[protein_coding])
```
