...
In Pharmacogenomics, the design of the experiment usually involves doing two things in parallel:
...
$E_infty$, which is the maximal inhibition predicted at infinite concetration of the drug (the right asymptote);
...
inhibition/binding of the target for the small molcule ligands, which values less than 1 imply negative cooperativity/
antagonism. 
